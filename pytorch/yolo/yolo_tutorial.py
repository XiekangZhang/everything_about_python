...
if __name__ == "__main__":
    ...
    input_layer = tf.keras.layers.Input(shape=(640, 640), name="input layer")
    hidden_layer1 = tf.keras.layers.Dense(units=1280, activation="sigmoid", name="hidden_layer_1")(input_layer)
    hidden_layer2 = tf.keras.layers.Dense(units=640, activation="relu", trainable=False, name="hidden_layer_2")(hidden_layer1)
    hidden_layer3 = tf.keras.layers.Dense(units=320, activation="relu", trainable=False, name="hidden_layer_3")(hidden_layer2)

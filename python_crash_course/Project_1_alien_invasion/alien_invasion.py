...
# TODO: add a file to store the highest score
# TODO: go through whole code
# TODO: pygame.mixer --> pygame documentation
class AlienInvasion:
    ...
    def _check_bullet_alien_collisions(self):
        ...
        if not self.aliens:
            # info: destroy existing bullets and create new fleet
            self.bullets.empty()
            self._create_fleet()
    ...
    def _update_aliens(self):
        ...
        self.aliens.update()
        # info: Look for alien-ship collisions
        if pygame.sprite.spritecollideany(self.ship, self.aliens):
            self._ship_hit()
        # info: Look for aliens hitting the bottom of the screen
